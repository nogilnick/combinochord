...
public class Constants
{
	...
	public static double[] defSclLen = {620, 660, 630};
	public static double[] defFrstFrtWdth = {38, 36.0, 34.0};
	public static double[] defBrgSpc = {58.7375, 56, 52};
	public static double[] defNutSpc = {44.45, 48, 46};
    //Guitar types
    public enum GuitTypes {Acoustic, Classical, Electric}
	//Default maximum distances between fingers
	//1-2, 1-3, 1-4, 2-3, 2-4, 3-4
	public static double[] defMaxFR = {80.0, 95.0, 110.0, 52.0, 69.0, 47.0};
	//Default minimum distances between fingers
	//1-2, 1-3, 1-4, 2-3, 2-4, 3-4
	public static double[] defMinFR = {5.0, 15.0, 25.0, 6.0, 12, 8.5};
	//Maximum distance between any two fingers
	public static double maxDist = 110.0;
	//Tunings
	public static int[] standard = {40, 45, 50, 55, 59, 64};
	public static int[] dropD = {38, 45, 50, 55, 59, 64};
	public static int[] baritone = {35, 40, 45, 50, 54, 59};
	public static int[] standard7 = {35, 40, 45, 50, 55, 59, 64};
	public static int[] standard8 = {28, 35, 40, 45, 50, 55, 59, 64};
	//Chords to be shifted a specific key
	public static int[][] genericChords = {
            {0, 4, 7, 9},      //6th chord
            {0, 2, 9},         //6th (no 5th)
            {0, 2, 4, 9},      //6/9
            {0, 4, 8},         //Augmented
	 ...
	 */
	public static int NoteToInt(int pitch, int octave)
	{
